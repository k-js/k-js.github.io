...
<head>
    <meta charset="utf-8" />
    <title>Keu Araujo</title>

    <!-- Meta Data -->
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <meta name="author" content="Keu Araujo" />
    <meta name="description" content="Portifólio de trabalhos realizados e formação de Keu Araujo " />
    <!-- Styles -->
        ...
        <div class="container gutter-top">
            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/perfil.jpeg" alt="K">
                    </div>
                    <div class="header__base-info">
                        <h4 class="title titl--h4">Keu Araujo</h4>
                    ...
                    <ul class="header__contact">
                        ...
                        <li>
                            <span class="overhead">Telefone</span><a
                                href="https://api.whatsapp.com/send?phone=55xxxxxxxxxxx">+55 (71) xxxxx-xxxx </a>
                        </li>
                    </ul>
                    <ul class="header__contact">
            ...
            <div class="row sticky-parent">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                            ...
                            <div class="gallery-grid js-grid-row js-filter-container">
                                ...
                                <figure class="gallery-grid__item category-html category-js">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/atleta.jpg"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">Atleta</h4>
                                        <span class="gallery-grid__category">u.com.br </span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure class="gallery-grid__item category-wordpress">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/cueca.jpg"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">Corrupto</h4>
                                        <span class="gallery-grid__category">i.com.br </span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure class="gallery-grid__item category-wordpress">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/fake.jpg"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">Fake</h4>
                                        <span class="gallery-grid__category">e.com.br </span>
                                    </figcaption>
                                </figure>
                    ...
                    <!-- Footer -->
                    <footer class="footer">© Keu Araujo
