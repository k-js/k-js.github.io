        ...
        <div class="container gutter-top">
            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/perfil.jpeg" alt="Keu Araujo">
                    </div>
            ...
            <div class="row sticky-parent">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                            ...
                            <div class="col-12">
                                ...
                                <div class="timeline">
                                    ...
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Licenciatura em Ciências Exatas
                                        </h5>
                                        <span class="timeline__period">2019 — 2023</span>
                                        <p class="timeline__description">Universidade Federal do Paraná </p>
                                    </article>
                                ...
                                <div class="box box__border">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="1" aria-valuemin="0"
                                            aria-valuemax="100">
                                            <div class="progress-text"><span>PHP</span><span>1%</span></div>
                                        </div>
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="20"
                                            aria-valuemin="0" aria-valuemax="100">
                                            <div class="progress-text"><span>Node.js</span><span>15%</span></div>
                                        </div>
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="30"
                                            aria-valuemin="0" aria-valuemax="100">
                                            <div class="progress-text"><span>CSS</span><span>30%</span></div>
                                        </div>
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="30"
                                            aria-valuemin="0" aria-valuemax="100">
                                            <div class="progress-text"><span>HTML</span><span>30%</span></div>
                                        </div>
                    ...
                    <!-- Footer -->
                    <footer class="footer">© Keu Araujo</footer>
                </div>
            </div>
        </div>
    </main>
